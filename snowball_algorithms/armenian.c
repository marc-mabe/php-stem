...
extern "C" {
#endif
extern int armenian_stem(struct SN_env * z);
#ifdef __cplusplus
}
#endif
...
extern struct SN_env * armenian_create_env(void);
extern void armenian_close_env(struct SN_env * z);
...
extern struct SN_env * armenian_create_env(void) { return SN_create_env(0, 2, 0); }

extern void armenian_close_env(struct SN_env * z) { SN_close_env(z, 0); }
