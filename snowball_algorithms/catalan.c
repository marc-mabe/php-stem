...
extern "C" {
#endif
extern int catalan_stem(struct SN_env * z);
#ifdef __cplusplus
}
#endif
...
extern struct SN_env * catalan_create_env(void);
extern void catalan_close_env(struct SN_env * z);
...
extern struct SN_env * catalan_create_env(void) { return SN_create_env(0, 2, 0); }

extern void catalan_close_env(struct SN_env * z) { SN_close_env(z, 0); }
