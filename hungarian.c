...
extern "C" {
#endif
extern int hungarian_stem(struct SN_env * z);
#ifdef __cplusplus
}
#endif
...
extern struct SN_env * hungarian_create_env(void);
extern void hungarian_close_env(struct SN_env * z);
...
extern struct SN_env * hungarian_create_env(void) { return SN_create_env(0, 1, 0); }

extern void hungarian_close_env(struct SN_env * z) { SN_close_env(z, 0); }
