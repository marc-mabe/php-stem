...
extern "C" {
#endif
extern int romanian_stem(struct SN_env * z);
#ifdef __cplusplus
}
#endif
...
extern struct SN_env * romanian_create_env(void);
extern void romanian_close_env(struct SN_env * z);
...
extern struct SN_env * romanian_create_env(void) { return SN_create_env(0, 3, 1); }

extern void romanian_close_env(struct SN_env * z) { SN_close_env(z, 0); }
