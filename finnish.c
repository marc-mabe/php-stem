...
extern "C" {
#endif
extern int finnish_stem(struct SN_env * z);
#ifdef __cplusplus
}
#endif
...
extern struct SN_env * finnish_create_env(void);
extern void finnish_close_env(struct SN_env * z);
...
extern struct SN_env * finnish_create_env(void) { return SN_create_env(1, 2, 1); }

extern void finnish_close_env(struct SN_env * z) { SN_close_env(z, 1); }
