...
extern "C" {
#endif
extern int basque_stem(struct SN_env * z);
#ifdef __cplusplus
}
#endif
...
extern struct SN_env * basque_create_env(void);
extern void basque_close_env(struct SN_env * z);
...
extern struct SN_env * basque_create_env(void) { return SN_create_env(0, 3, 0); }

extern void basque_close_env(struct SN_env * z) { SN_close_env(z, 0); }
